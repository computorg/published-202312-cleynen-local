...
kableExtra::kable(Table2, booktabs=T, row.names=NA)
...
kableExtra::kable(Table4, booktabs=T, row.names=NA)
...
kableExtra::kable(TableOrderedS, booktabs=T, row.names=NA)
...
kableExtra::kable(Table5, booktabs=T, row.names=NA)
