...
kableExtra::kable(Table2, format="latex", row.names=NA)
...
kableExtra::kable(Table4, format="latex", row.names=NA)
...
kableExtra::kable(TableOrderedS, format="latex", row.names=NA)
...
kableExtra::kable(Table5, format="latex", row.names=NA)
...
kableExtra::kable(TableOrdered, format="latex", row.names=NA)
